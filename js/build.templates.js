...
this["Fliplet"]["Widget"]["Templates"]["templates.message"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\""
    ...
    + "\">\n  <p>\n    <strong>"
    + alias3(alias2(((stack1 = (depth0 != null ? depth0.sender : depth0)) != null ? stack1.fullName : stack1), depth0))
    + "</strong> ("
    + alias3(((helper = (helper = helpers.timeAgo || (depth0 != null ? depth0.timeAgo : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"timeAgo","hash":{},"data":data}) : helper)))
    + ")<br />\n    "
    + alias3(alias2(((stack1 = (depth0 != null ? depth0.message : depth0)) != null ? stack1.body : stack1), depth0))
    + "\n  </p>\n</li>";
},"useData":true});
